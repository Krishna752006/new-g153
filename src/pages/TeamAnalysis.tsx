  ...
  const teams = {
    'Chennai Super Kings': {
      ...
      players: [
        ...
        { name: 'Jamie Overton', price: 'Rs 1.5 Crore' },
    ...
    'Royal Challengers Bangalore': {
      ...
      titles: 0,
      winRate: 48.4,
      keyPlayers: ['Virat Kohli', 'AB de Villiers', 'Glenn Maxwell'],
    ...
    'Delhi Capitals': {
      ...
      titles: 0,
      winRate: 44.5,
      keyPlayers: ['Rishabh Pant', 'Prithvi Shaw', 'Anrich Nortje'],
      ...
      players: [
        ...
        { name: 'Vipraj Nigam', price: 'Rs 50 lakh' },
    ...
    'Punjab Kings': {
      ...
      titles: 0,
      winRate: 47.8,
      keyPlayers: ['Shikhar Dhawan', 'Liam Livingstone', 'Kagiso Rabada'],
    ...
    'Sunrisers Hyderabad': {
      ...
      titles: 1,
      winRate: 54.3,
      keyPlayers: ['David Warner', 'Kane Williamson', 'Rashid Khan'],
